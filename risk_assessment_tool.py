...
A3 = ["N/A", "Regular", "Frequent", "Occasional", "Rare", "Never"]
A4 = ["N/A", "Regular", "Frequent", "Occasional", "Rare", "No access"]
...
A7 = ["N/A", "High Level", "Proficient", "Moderate", "Low", "Not Proficient"]
A8 = ["N/A", "High Level", "Proficient", "Moderate", "Low", "Not Proficient"]
A9 = ["N/A", "High Level", "Proficient", "Moderate", "Low", "Not Proficient"]
...
A12 = ["N/A", "No Damage", "Low Damage", "Some Damage", "Moderate Damage", "Major Damage"]
A13 = ["N/A", "No Damage", "Low Damage", "Some Damage", "Moderate Damage", "Major Damage"]
...
x_pt = likelihood_total/likelihood_answers
y_pt = consequence_total/consequence_answers
...
fig, ax = plt.subplots()
ax.set_xlabel('Likelihood of Failure')
ax.set_ylabel('Consequence of Failure')
plt.xlim([1,5])
plt.ylim([1,5])
...
y_low = np.array([3,3,1,1,1,1,0,0,0,0])
...
plt.legend(handles=[red_patch, orange_patch, yellow_patch, green_patch, black_circle, blue_square], bbox_to_anchor=(1.05,1), loc=2, borderaxespad=0.)
my_fig = plt.show()


# TEXT OUTPUT
st.pyplot(fig)
st.markdown(f"Risk assessment score is **{report_ra}**")
st.markdown(f"Likelihood of Failure = **{round(x_pt,1)}**")
st.markdown(f"Consequence of Failure = **{round(y_pt,1)}**")
...
with header:
    ...
    of questions answered. A normalized score is also plotted based on the nearest integer score.')
    st.markdown('This is a webapp based on the Engineers & Geoscientists BC Practice Risk Assessment Tool found \
    in the Appendix to the ["Guide to the Continuing Education Program" version 3.0](https://www.egbc.ca/getmedia/86710280-a428-4035-b596-e495bf36249d/EGBC-Guide-to-the-CEP-V1-0.pdf.aspx). This tool has been developed \
